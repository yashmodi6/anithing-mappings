...
/**
 * Creates a term frequency vector (bag of words) for a given text.
 */
 ...
 *     This handles word-order differences caused by translation (e.g. "Pirate King" vs "King of the Pirates")
 *     and is extremely lightweight. Threshold: 0.7.
 *
...
export function titlesMatch(t1: string, t2: string): boolean {
  ...
  // Vector match using Cosine Similarity (threshold: 70%)
